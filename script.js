...
const days = [
  ...
  },
  {
    ...
    body: "Sanfter Start nach der kurzen Nacht: Strandtag an Cala Llombards, baden, an den Felsterrassen chillen, Snacks.",
  ...
  },
  {
    ...
    body: "Bergkloster Sant Salvador (360°-Panorama, hochfahrbar), dann Burgruine Castell de Santueri (4€, nur Bargeld).",
  ...
  },
  {
    ...
    body: "Coves del Drach in Porto Cristo (~1 Std.): Tropfsteinhöhlen, unterirdischer See, klassisches Konzert, Bootsfahrt. Tickets vorab online. Danach Cala Marçal.",
    footerLabel: "ZU HAUSE",
  ...
  },
  {
    ...
    footerText: "Abschiedsdinner – auswärts o. gemütlich selbst gemacht, ganz nach Lust.",
